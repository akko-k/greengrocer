...
class Greengrocer
  ...
  def disp
    puts "商品を選択してください"
    @products.each.with_index(@id) do |product, id|
...
greengrocer1.disp
# 商品の決定
selected_product = user.choose(greengrocer1)
# 個数を訊ねる
greengrocer1.ask_quantity(selected_product)
...
greengrocer2.disp
# 商品の決定
selected_product = user.choose(greengrocer2)
# 個数を訊ねる
greengrocer2.ask_quantity(selected_product)